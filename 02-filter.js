...
Funcao: Percorre o array e SELECIONA apenas os itens que atendem a uma
condicão (retornam true). Gera um NOVO array com tamanho menor ou igual ao original.
*/
...
{ id: 104, nome: "Headset USB", categoria: "Perifericos", preco: 180.0, estoque: 8, ativo: true },
...
return item.categoria === "Perifericos" && item.ativo && item.estoque > 0;
});
